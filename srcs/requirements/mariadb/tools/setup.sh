...
# echo "[DB Container] mariadb installation script..."

# mysql_install_db

# mysqld --bind-address=127.0.0.1 --user=root --datadir=/data
# sleep 1
...
# echo "[DB Container] reboot..."
# mysql restart

# echo "[DB Container] starting mysqld"
# mysqld --bind-address=0.0.0.0 --console --user=root --datadir=/data 
